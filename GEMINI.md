...
# Memraft Context For Gemini CLI

This file is compiled for `GEMINI.md` consumers from repo facts plus promoted Memraft rules.
...
- Gemini CLI adapter mode: inject-only
- Gemini CLI capture remains manual-only; use the manual capture path when you need persistence.
